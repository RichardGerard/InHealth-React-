    ...
    <TouchableOpacity
      ...
      <View style={styles.chatIconContainer}>
        ...
        <View style={styles.container}>
          {name && <Text style={[styles.name,{alignSelf: 'flex-start',marginLeft:10}]}>{name}</Text>}
          {name && <Text style={[styles.name,{alignSelf: 'flex-start',marginLeft:10}]}>{user.email}</Text>}
         </View>
      </View>
