...
const ChatConfig = {
  ...
  onboardingConfig: {
    welcomeTitle: IMLocalized('IN HEALTH'),
    welcomeCaption: IMLocalized(
      'MEDICAL EFFCENCY AT ITS BEST',
    ),
    walkthroughScreens: [
      {
      ...
      },
      {
        ...
        title: IMLocalized('Search Doctors'),
        description: IMLocalized(
          'Patients can search docotrs as well',
        ),
      },
      {
        icon: require('../assets/icons/camera-walkthrough-icon.png'),
        title: IMLocalized('Booking system'),
        description: IMLocalized(
          'Patients can booking anytime with doctors',
        ),
      },
      {
  ...
  drawerMenu: {
    upperMenu: [
      ...
      },
      {
        ...
        icon:
          Platform.OS === 'ios'
            ? DynamicAppStyles.iconSet.search
            : DynamicAppStyles.iconSet.search,
        navigationPath: 'SearchStack',
      },
      {
